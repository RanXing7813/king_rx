...
function go(pages){
 ...
 //Array(14) 0:"MH_ID"1:"MH_ZYID"2:"MH_ZYNAME"3:"MH_ZYDEPTID"4:"MH_XXTABLENAME"5:"CREATE_TIME"6:UPDATE_TIME 7:"CREATE_ID"8:"UPDATE_ID"9:"MH_MODELNAME"10:"MH_MODELADDRES"11:"MH_MODELSTATUS"12:UPLOAD_TIME 13:ISDELETE length:14
  	 				list += '<tr>'+
  	 					 '<td class="fn-text-center" title="'+value[0]+'"><input type="checkbox" name="publishDepts" value="'+value[0]+'" /></td>'+
		  	 			...
		  	 			// '<td class="fn-text-center"><a href="#" onclick="checkThis(\''+value[0]+'\',\''+value[2]+'\')">确定</a></td>'+
		  			   '</tr>'
  	 			})
  	 		$("#grid").html(list);
  	 		//加载分页信息
